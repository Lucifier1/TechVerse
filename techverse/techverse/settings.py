"""
Django settings for techverse project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app_modules.userapp.context_processors.global_data',
            ],
        },
    },
]

WSGI_APPLICATION = 'techverse.wsgi.application'
